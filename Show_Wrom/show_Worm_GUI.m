function show_Worm_GUI(worm_show, Y_k, width, seg_len, ind, diff, loc, inn_result, handles)
...
%text(5,2+loc*10,c);
set(handles.text21,'string',num2str(round(diff)));
...
hold on
plot(worm_shape_x,worm_shape_y,'LineWidth',1,'Color',[1 0.1*ind 0.16*ind]);
