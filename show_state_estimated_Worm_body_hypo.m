function show_state_estimated_Worm_body_hypo(X, Y_k, width)
...
% [worm_shape,worm_body] = ske2shape(worm_ske1, worm_ske1_N, width, -0.25);
...
plot(worm_ske_curv_x,worm_ske_curv_y,'LineWidth',4,'Color',[1 0.1 0.1]);
